...
//: for(my $i=0; $i<8/2; $i++){
//: print qq(
//: wire [19 -1:0] mac_a2accu_dst_data${i}; )
//: }
//| eperl: generated_beg (DO NOT EDIT BELOW)

wire [19 -1:0] mac_a2accu_dst_data0; 
wire [19 -1:0] mac_a2accu_dst_data1; 
wire [19 -1:0] mac_a2accu_dst_data2; 
wire [19 -1:0] mac_a2accu_dst_data3; 
//| eperl: generated_end (DO NOT EDIT ABOVE)
wire [8/2-1:0] mac_a2accu_dst_mask;
wire mac_a2accu_dst_mode;
wire [8:0] mac_a2accu_dst_pd;
wire mac_a2accu_dst_pvld;
//: for(my $i=0; $i<8/2; $i++){
//: print qq(
//: wire [19 -1:0] mac_a2accu_src_data${i}; )
//: }
//| eperl: generated_beg (DO NOT EDIT BELOW)

wire [19 -1:0] mac_a2accu_src_data0; 
wire [19 -1:0] mac_a2accu_src_data1; 
wire [19 -1:0] mac_a2accu_src_data2; 
wire [19 -1:0] mac_a2accu_src_data3; 
//| eperl: generated_end (DO NOT EDIT ABOVE)
wire [8/2-1:0] mac_a2accu_src_mask;
wire mac_a2accu_src_mode;
wire [8:0] mac_a2accu_src_pd;
wire mac_a2accu_src_pvld;
//: for(my $i=0; $i<8/2; $i++){
//: print qq(
//: wire [19 -1:0] mac_b2accu_src_data${i}; )
//: }
//| eperl: generated_beg (DO NOT EDIT BELOW)

wire [19 -1:0] mac_b2accu_src_data0; 
wire [19 -1:0] mac_b2accu_src_data1; 
wire [19 -1:0] mac_b2accu_src_data2; 
wire [19 -1:0] mac_b2accu_src_data3; 
//| eperl: generated_end (DO NOT EDIT ABOVE)
wire [8/2-1:0] mac_b2accu_src_mask;
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
wire [8 -1:0] sc2mac_dat_a_dst_mask;
wire [8:0] sc2mac_dat_a_dst_pd;
wire sc2mac_dat_a_dst_pvld;
wire [8 -1:0] sc2mac_dat_a_src_mask;
wire [8:0] sc2mac_dat_a_src_pd;
wire sc2mac_dat_a_src_pvld;
wire [8 -1:0] sc2mac_dat_b_dst_mask;
wire [8:0] sc2mac_dat_b_dst_pd;
wire sc2mac_dat_b_dst_pvld;
wire [8 -1:0] sc2mac_wt_a_dst_mask;
wire sc2mac_wt_a_dst_pvld;
wire [8/2-1:0] sc2mac_wt_a_dst_sel;
wire [8 -1:0] sc2mac_wt_a_src_mask;
wire sc2mac_wt_a_src_pvld;
wire [8/2-1:0] sc2mac_wt_a_src_sel;
wire [8 -1:0] sc2mac_wt_b_dst_mask;
wire sc2mac_wt_b_dst_pvld;
wire [8/2-1:0] sc2mac_wt_b_dst_sel;
////////////////////////////////////////////////////////////////////////////////
...
NV_NVDLA_partition_o u_partition_o (
  ...
  ,.sc2mac_dat_a_dst_mask (sc2mac_dat_a_dst_mask[8 -1:0])
  ,.sc2mac_dat_a_dst_pd (sc2mac_dat_a_dst_pd[8:0])
  ,.sc2mac_dat_a_src_pvld (sc2mac_dat_a_src_pvld)
  ,.sc2mac_dat_a_src_mask (sc2mac_dat_a_src_mask[8 -1:0])
  ,.sc2mac_dat_a_src_pd (sc2mac_dat_a_src_pd[8:0])
  ,.sc2mac_wt_a_dst_pvld (sc2mac_wt_a_dst_pvld)
  ,.sc2mac_wt_a_dst_mask (sc2mac_wt_a_dst_mask[8 -1:0])
  ,.sc2mac_wt_a_dst_sel (sc2mac_wt_a_dst_sel[8/2-1:0])
  ,.sc2mac_wt_a_src_pvld (sc2mac_wt_a_src_pvld)
  ,.sc2mac_wt_a_src_mask (sc2mac_wt_a_src_mask[8 -1:0])
//: my $kk=8 -1;
//: foreach my $i (0..${kk}){
//: print qq(
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
  ,.sc2mac_wt_a_src_sel (sc2mac_wt_a_src_sel[8/2-1:0])
  );
////////////////////////////////////////////////////////////////////////
// NVDLA Partition C //
////////////////////////////////////////////////////////////////////////
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
  ...
  ,.sc2mac_dat_b_dst_mask (sc2mac_dat_b_dst_mask[8 -1:0])
  ,.sc2mac_dat_b_dst_pd (sc2mac_dat_b_dst_pd[8:0])
  ,.sc2mac_wt_a_src_pvld (sc2mac_wt_a_src_pvld)
  ,.sc2mac_wt_a_src_mask (sc2mac_wt_a_src_mask[8 -1:0])
  ,.sc2mac_wt_a_src_sel (sc2mac_wt_a_src_sel[8/2-1:0])
  ,.sc2mac_wt_b_dst_pvld (sc2mac_wt_b_dst_pvld)
  ,.sc2mac_wt_b_dst_mask (sc2mac_wt_b_dst_mask[8 -1:0])
  ,.sc2mac_wt_b_dst_sel (sc2mac_wt_b_dst_sel[8/2-1:0])
  ,.nvdla_core_clk (dla_core_clk)
...
NV_NVDLA_partition_a u_partition_a (
  ...
  ,.mac_a2accu_dst_mask (mac_a2accu_dst_mask[8/2-1:0])
  ,.mac_a2accu_dst_mode (mac_a2accu_dst_mode)
//: for(my $i=0; $i<8/2 ; $i++){
//: print qq(
//: ,.mac_a2accu_dst_data${i} (mac_a2accu_dst_data${i}[19 -1:0]) )
//: }
//| eperl: generated_beg (DO NOT EDIT BELOW)

,.mac_a2accu_dst_data0 (mac_a2accu_dst_data0[19 -1:0]) 
,.mac_a2accu_dst_data1 (mac_a2accu_dst_data1[19 -1:0]) 
,.mac_a2accu_dst_data2 (mac_a2accu_dst_data2[19 -1:0]) 
,.mac_a2accu_dst_data3 (mac_a2accu_dst_data3[19 -1:0]) 
//| eperl: generated_end (DO NOT EDIT ABOVE)
  ,.mac_a2accu_dst_pd (mac_a2accu_dst_pd[8:0])
  ,.mac_b2accu_src_pvld (mac_b2accu_src_pvld)
  ,.mac_b2accu_src_mask (mac_b2accu_src_mask[8/2-1:0])
  ,.mac_b2accu_src_mode (mac_b2accu_src_mode)
//: for(my $i=0; $i<8/2 ; $i++){
//: print qq(
//: ,.mac_b2accu_src_data${i} (mac_b2accu_src_data${i}[19 -1:0]) )
//: }
//| eperl: generated_beg (DO NOT EDIT BELOW)

,.mac_b2accu_src_data0 (mac_b2accu_src_data0[19 -1:0]) 
,.mac_b2accu_src_data1 (mac_b2accu_src_data1[19 -1:0]) 
,.mac_b2accu_src_data2 (mac_b2accu_src_data2[19 -1:0]) 
,.mac_b2accu_src_data3 (mac_b2accu_src_data3[19 -1:0]) 
//| eperl: generated_end (DO NOT EDIT ABOVE)
...
//| eperl: generated_end (DO NOT EDIT ABOVE)
  ...
  ,.mac_a2accu_src_mask (mac_a2accu_src_mask[8/2-1:0])
  ,.mac_a2accu_src_mode (mac_a2accu_src_mode)
//: for(my $i=0; $i<8/2 ; $i++){
//: print qq(
//: ,.mac_a2accu_src_data${i} (mac_a2accu_src_data${i}[19 -1:0]) )
//: }
//| eperl: generated_beg (DO NOT EDIT BELOW)

,.mac_a2accu_src_data0 (mac_a2accu_src_data0[19 -1:0]) 
,.mac_a2accu_src_data1 (mac_a2accu_src_data1[19 -1:0]) 
,.mac_a2accu_src_data2 (mac_a2accu_src_data2[19 -1:0]) 
,.mac_a2accu_src_data3 (mac_a2accu_src_data3[19 -1:0]) 
//| eperl: generated_end (DO NOT EDIT ABOVE)
